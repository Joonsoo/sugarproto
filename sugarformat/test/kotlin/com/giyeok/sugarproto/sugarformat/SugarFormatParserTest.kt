...
class SugarFormatParserTest {
  ...
  fun testDuration() {
    ...
    Truth.assertThat(convertToJsonFormat("1h")).isEqualTo("3600s")
    Truth.assertThat(convertToJsonFormat("1m")).isEqualTo("60s")
    Truth.assertThat(convertToJsonFormat("1h 30m")).isEqualTo("5400s")
    Truth.assertThat(convertToJsonFormat("1s")).isEqualTo("1s")
    Truth.assertThat(convertToJsonFormat("0.000000001s")).isEqualTo("0.000000001s")
    Truth.assertThat(convertToJsonFormat("123.456s")).isEqualTo("123.456s")
    Truth.assertThat(convertToJsonFormat("1d")).isEqualTo("86400s")
  }
